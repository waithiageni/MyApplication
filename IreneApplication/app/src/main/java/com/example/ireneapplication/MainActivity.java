...
//                startActivity(new Intent(getBaseContext(),TrialActivity.class));
        ...
        IreneWork = (TextView) findViewById(R.id.IreneWork);
        IreneWork.setText("The quick brown fox jumped over the lazy dog");
        ...
        btnViewNote.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(),AddViewActvity.class));
            }
        });
    }
